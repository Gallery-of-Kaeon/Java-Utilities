...
public class XMLReader {
	...
	public static void readXML(XML metadata, ArrayList<String> file) {
		parseFile(metadata, file);
	}
	
	public static void parseFile(XML metadata, ArrayList<String> file) {
	...
	private static void parseLine(XML metadata, String line) {
	...
	private static void addContent(XML metadata, String content) {
	...
	private static void parseTag(XML metadata, String tag) {
