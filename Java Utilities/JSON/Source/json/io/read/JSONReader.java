package json.io.read;

import java.util.ArrayList;

import json.JSON;
import json.containers.arrays.JSONArray;
import json.containers.objects.JSONObject;
import json.containers.objects.JSONObjectField;
import json.values.JSONValue;

public class JSONReader {
	
	public static void readJSON(JSON json, ArrayList<String> file) {
		pushContainers(json, new FileScanner(file));
	}
	
	private static void pushContainers(JSON json, FileScanner file) {
